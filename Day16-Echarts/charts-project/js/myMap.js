(function() {
    ...
    function makeShapePoints(params, widthRadius, startRadius, endRadian) {
        ...
        for (
            var iRadian = _startRadian, end = endRadian - _radianStep; iRadian > end; iRadian -= _radianStep
        ) {
        ...
        for (
            var iRadian = endRadian; iRadian < _startRadian + _radianStep; iRadian += _radianStep
        ) {
    ...
    function convertToPolarPoint(renderItemParams, radius, radian) {
        return [
            Math.cos(radian) * radius + renderItemParams.coordSys.cx, -Math.sin(radian) * radius + renderItemParams.coordSys.cy
        ];
    }
    var option = {
